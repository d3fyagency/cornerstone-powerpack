...
class Plugin_Name {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $cornerstone_powerpack    The string used to uniquely identify this plugin.
	 */
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Plugin_Name_Admin( $this->get_cornerstone_powerpack(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Plugin_Name_Public( $this->get_cornerstone_powerpack(), $this->get_version() );
