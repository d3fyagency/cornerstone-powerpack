...
/* Paths */
define( 'CSL_SIMPLECONTACTFORM_PATH', plugin_dir_path( __FILE__ ) );
define( 'CSL_SIMPLECONTACTFORM_URL', plugin_dir_url( __FILE__ ) );


/* Add element to Cornerstone */
add_action( 'cornerstone_register_elements', 'csl_simplecontactform_register_elements' );

/* Add Icon Map */
add_filter( 'cornerstone_icon_map', 'csl_simplecontactform_icon_map');

/* scripts */
add_action( 'wp_enqueue_scripts', 'csl_simplecontactform_scripts');
