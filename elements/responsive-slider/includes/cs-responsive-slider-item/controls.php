...
return array(
	...
	'slider_image_alt' => array(
		'type' => 'text',
		'ui'   => array(
			'title'   => __( 'Add alt text', 'cs-responsive-slider' ),
	...
	'overlay_bg_color' => array(
	 	'type' => 'color',
	 	'ui' => array(
			'title'   => __( 'Overlay Background Color', 'my-extension' )
		)
	),
	...
	'overlay_padding' => array(
		'type'    => 'select',
		'ui'      => array(
			'title'   => __( 'Overlay Padding (all sides)', 'cs-responsive-slider' ),
		),
		'options' => array(
			'choices' => array(
				array(
	...
	'overlay_text_color' => array(
	 	'type' => 'color',
	 	'ui' => array(
			'title'   => __( 'Overlay Text Color', 'my-extension' )
		)
	),
	...
	'content_show_min' => array(
		'type'    => 'number',
		'ui' => array(
			'title'   => __( 'Hide Content Block if Viewport Smaller Than (in pixels):', 'cs-responsive-slider' ),
